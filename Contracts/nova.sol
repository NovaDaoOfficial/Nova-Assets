...
contract NovaERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    uint256 fee = 2;
    address feeAddress = 0xBff5A77059231B99C385978fA98d2E64e26FC463;

    constructor() ERC20("Nova ", "NOVA", 9) {
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        super._transfer(sender, feeAddress, fees);
    ...
    function setFeeAddress(address payable wallet) external onlyOwner() {
      feeAddress = wallet;
    }
